...
HAL/peripherals/Source/%.o: ../HAL/peripherals/Source/%.c HAL/peripherals/Source/subdir.mk
	...
	riscv64-unknown-elf-gcc -march=rv32imc_zicsr_zifencei -mabi=ilp32 -msmall-data-limit=8 -mstrict-align -mno-save-restore -Og  -g3 -DMIK32V2 -I"C:\MikronIDE\workspace\template2\src\core" -I"C:\MikronIDE\workspace\template2\src\periphery" -I"C:\MikronIDE\workspace\template2\HAL\core\Include" -I"C:\MikronIDE\workspace\template2\HAL\peripherals\Include" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
